...
namespace F
{
    ...
    internal sealed class FastDictionaryDebugView<K, V> where K : IEquatable<K>
    {
        private readonly FastDictionary<K, V> mDictionary;
        public FastDictionaryDebugView(FastDictionary<K, V> dictionary) { mDictionary = dictionary ?? throw new ArgumentNullException(nameof(dictionary)); }
        [DebuggerBrowsable(DebuggerBrowsableState.RootHidden)]
        public KeyValuePair<K, V>[] Items => mDictionary.ToArray();
    }
    //https://github.com/redknightlois/fastdictionary.git
    ...
    [DebuggerTypeProxy(typeof(FastDictionaryDebugView<,>))]
    ...
    public class FastDictionary<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
    {
        ...
        public struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>
        {
            ...
            {
                get { return current = new KeyValuePair<TKey, TValue>(Key, Value); }
            }
            ...
            public ref TValue Value
            {
                get
                {
                    return ref dictionary._entries[index - 1].Value;
                }
            }
            ...
            public TKey Key
            {
                get
                {
                    return dictionary._entries[index - 1].Key;
                }
            }
